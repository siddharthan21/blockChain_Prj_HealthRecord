...
import AllPatientsView from "./components/ViewPatientRecords";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/api/patients" element={<AllPatientsView ></AllPatientsView>} />


        <Route path="/patient/:hhNumber/viewrecords" element={<ViewPatientList />} />
